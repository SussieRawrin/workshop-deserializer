...
const boxes = {
    ...
    ['box', parsimmon_1.alt(x.gameSetting, x.description, x.group, 
    ...
    /* rule boxes */
    // TODO optional
    ['code', parsimmon_1.seqMap(x.gameSettingName, x._, parsimmon_1.string('{'), x._, 
        /* code lines */
